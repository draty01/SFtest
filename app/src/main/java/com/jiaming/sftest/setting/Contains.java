...
public class Contains {
    public static final int   SNAKE_ATTRACT_RAD_dp = 10;
    public static final int   SNAKE_ATTRACT_RAD_PX = DensityUtil.dip2px(SNAKE_ATTRACT_RAD_dp);
    public static       int   STAGE_WIDTH          = 2000; //这里单位为dp
    public static       int   STAGE_HEIGHT         = 1500; //这里单位为dp
